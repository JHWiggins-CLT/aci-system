...
| Phase 6 — Pattern emergence + maintain skill | in progress (exit criteria met) | [.skills/maintain/procedures/](.skills/maintain/procedures/) (add_calc, add_pattern, update_pattern), [pattern.md template](.skills/maintain/templates/pattern.md), [patterns/equipment_downtime_throughput_drag.md](data/patterns/equipment_downtime_throughput_drag.md) + [patterns/INDEX.md](data/patterns/INDEX.md) | All Phase 6 exit criteria met: 1 pattern with countermeasures, patterns/INDEX.md, throughput_drop consults the library, maintain skill with 3 procedures registered. Marked "in progress" only because `add_playbook.md` + the remaining maintain procedures (Phase 8) aren't authored. |
